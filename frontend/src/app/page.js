    ...
    return (
        <div style={{ background: 'var(--dark)', minHeight: '100vh', overflow: 'hidden' }}>
            ...
            <nav style={{
                ...
                padding: '0 clamp(16px, 5vw, 40px)', height: 'clamp(52px, 10vh, 64px)', display: 'flex', alignItems: 'center', justifyContent: 'space-between'
            }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 'clamp(6px, 2vw, 10px)' }}>
                    <span style={{ fontSize: 'clamp(1.2rem, 4vw, 1.5rem)' }}>🚗</span>
                    <span style={{ fontSize: 'clamp(0.9rem, 3vw, 1.1rem)', fontWeight: 800, background: 'linear-gradient(135deg, #6C63FF, #4ECDC4)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                        Mind Spark
                    </span>
                    <span style={{ color: 'var(--text-muted)', fontSize: 'clamp(0.65rem, 2vw, 0.8rem)', marginTop: 2, display: 'none', '@media (min-width: 640px)': { display: 'inline' } }}>Parking</span>
                </div>
            ...
            <section style={{
                ...
                {/* Background blobs */}
                <div style={{ position: 'absolute', top: '10%', left: '5%', width: 'clamp(200px, 40vw, 400px)', height: 'clamp(200px, 40vw, 400px)', background: 'rgba(108,99,255,0.06)', borderRadius: '50%', filter: 'blur(80px)', pointerEvents: 'none' }} />
                <div style={{ position: 'absolute', bottom: '20%', right: '5%', width: 'clamp(150px, 30vw, 300px)', height: 'clamp(150px, 30vw, 300px)', background: 'rgba(78,205,196,0.06)', borderRadius: '50%', filter: 'blur(60px)', pointerEvents: 'none' }} />
                ...
                <h1 style={{
                    fontSize: 'clamp(1.8rem, 6vw, 5rem)', fontWeight: 900, lineHeight: 1.08,
                    maxWidth: 800, marginBottom: 'clamp(16px, 4vw, 24px)',
                ...
                <p style={{ fontSize: 'clamp(0.9rem, 3vw, 1.15rem)', color: 'var(--text-secondary)', maxWidth: 560, marginBottom: 'clamp(24px, 6vw, 40px)', lineHeight: 1.75 }}>
                ...
                <div style={{ display: 'flex', gap: 'clamp(8px, 2vw, 16px)', flexWrap: 'wrap', justifyContent: 'center', marginBottom: 'clamp(32px, 8vw, 60px)', width: '100%', paddingLeft: 'clamp(8px, 2vw, 0px)', paddingRight: 'clamp(8px, 2vw, 0px)' }}>
                ...
                <div style={{
                    ...
                    {[
                        ...
                        <div key={stat.label} style={{ textAlign: 'center' }}>
                            <div style={{ fontSize: 'clamp(1.1rem, 3vw, 1.5rem)', fontWeight: 800, color: 'var(--primary-light)' }}>{stat.value}</div>
                            <div style={{ fontSize: 'clamp(0.65rem, 2vw, 0.78rem)', color: 'var(--text-secondary)', marginTop: 2 }}>{stat.label}</div>
                        </div>
                    ))}
                </div>
            </section>
